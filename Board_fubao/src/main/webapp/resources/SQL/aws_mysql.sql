...
CREATE TABLE TBL_BOARD (
	...
	b_like    INT        NOT NULL, -- 추천수
	b_hit     INT       NOT NULL,  -- 조회수
...
insert into TBL_CATEGORY (category_name) values  ('가입인사');
insert into TBL_CATEGORY (category_name) values  ('공지사항');
insert into TBL_CATEGORY (category_name) values  ('BAO Family 소식');
insert into TBL_CATEGORY (category_name) values  ('사육사와의 소통');
insert into TBL_CATEGORY (category_name) values  ('판다월드 관람/체험 후기');
insert into TBL_CATEGORY (category_name) values  ('자유게시판');
insert into TBL_CATEGORY (category_name) values  ('꿀팁게시판');
insert into TBL_CATEGORY (category_name) values  ('질문게시판');
insert into TBL_CATEGORY (category_name) values  ('팬아트');
insert into TBL_CATEGORY (category_name) values  ('인기글');
